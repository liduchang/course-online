      ...
      <div v-for="(course,index) in courses" :key="index" class="col-md-4">
        <div class="thumbnail search-thumbnail">
          ...
          <div class="caption">
            ...
            <div v-for="(teacher,index) in teachers.filter(t=>{return t.id===course.teacherId})" :key="index" class="profile-activity clearfix">
              <div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select v-model="course.teacherId" class="form-control">
                    <option v-for="(o,index) in teachers" v-bind:value="o.id" :key="index">{{o.name}}</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select v-model="course.level" class="form-control">
                    <option v-for="(o,index) in COURSE_LEVEL" v-bind:value="o.key" :key="index">{{o.value}}</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select v-model="course.charge" class="form-control">
                    <option v-for="(o,index) in COURSE_CHARGE" v-bind:value="o.key" :key="index">{{o.value}}</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select v-model="course.status" class="form-control">
                    <option v-for="(o,index) in COURSE_STATUS" v-bind:value="o.key" :key="index">{{o.value}}</option>
                  </select>
                </div>
              </div>
              <div class="form-group">
