      ...
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
          <div class="login-container">
            ...
            <div>
              <a href="http://localhost:8081/api/sys/token/login?token=sadfsdafvsdf" target="_blank">单点登录测试</a>
              <!-- <a href="http://localhost:8990/#/?token=sadfsdafvsdf" target="_blank">首页跳转</a> -->
            </div>
    ...
    methods: {
      login () {
        ...
        if (md5 !== rememberUser.md5) {
          this.user.password = hex_md5(this.user.password + KEY);
        }

        this.user.imageCodeToken = this.imageCodeToken;

        this.$ajax.post(process.env.VUE_APP_SERVER + '/system/admin/user/login', this.user).then(response=>{
          ...
          if (resp.success) {
            ...
            if (this.remember) {
              ...
              LocalStorage.set(LOCAL_KEY_REMEMBER_USER, {
                ...
                // password: this.user.passwordShow,
