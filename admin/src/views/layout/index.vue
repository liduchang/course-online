      ...
      <div id="sidebar" class="sidebar                  responsive                    ace-save-state">
        ...
        <ul class="nav nav-list">
          ...
          <li v-show="hasResource('03')" class="">
            ...
            <ul class="submenu">
              <li v-show="hasResource('0401')" class="" id="business-chapter-sidebar">
              ...
              <li v-show="hasResource('0402')" class="" id="business-section-sidebar">
              ...
              <li v-show="hasResource('0403')" class="" id="business-content-sidebar">
                <router-link to="/business/content">
                  <i class="menu-icon fa fa-caret-right"></i>
                  内容管理
                </router-link>
                <b class="arrow"></b>
